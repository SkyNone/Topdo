...
![Version](https://img.shields.io/badge/version-v2.1.1-2563eb?style=flat-square)
...
- [下载 Topdo v2.1.1 macOS Universal DMG](https://github.com/SkyNone/Topdo/releases/download/v2.1.1/Topdo_2.1.1_universal.dmg)
- [查看 v2.1.1 Release](https://github.com/SkyNone/Topdo/releases/tag/v2.1.1)
...
- **体验细节修复**：暗色模式、新建/详情页输入、快捷键说明、标签展示等细节继续打磨。
...
[下载 `Topdo_2.1.1_universal.dmg`](https://github.com/SkyNone/Topdo/releases/download/v2.1.1/Topdo_2.1.1_universal.dmg)，拖拽 `Topdo.app` 到 `Applications`。
...
- `.dmg`：`src-tauri/target/universal-apple-darwin/release/bundle/dmg/Topdo_2.1.1_universal.dmg`
